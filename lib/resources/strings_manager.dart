class AppStrings {
  ...
  static const createCommunication =
      "create communication channels. engage your team. track the location of each team member, and much more.";
  ...
  static const joinChannelViaQrCode = "join channel via qr code";
  ...
  static const manageChannelMembers = "manage channel members";
  static const manageMessages = "manage messages";
  static const helpAndFeedbacks = "help and feedback";
  static const setMeeting = "set meeting appointment";
  static const setAlarm = "Set Alarm";
  static const setAppointment = "set appointment";
  static const joinWithQrCode = "Join channel via qr code";
  static const youCanCreateABrandNewChannel =
      "you can create a brand new channel for you and your team. you can set password.";
  static const corporateChannel = "corporate channel";
  static const createCorporateOrProgram =
      "create corporate or program channel for you and your project teams and departments. Design to make your teams effective on the go.";
  static const clickToCreate = "click to create";
  static const personalChannel = "personal channel";
  static const createPersonalChannel =
      "create personal channel for family and friends. This is designed for small circle or a one to one communication";
  static const addAChannelByName = "add yourself to a channel";
  static const scanqrcodetojion = "scan qr code to join a channel";
  static const requestSubmitted = "request submitted successfully!";
  static const addASubChannelByName = "create a new sub-channel";
  static const ifYouKnow =
      "If your know the channel you want join. Simply add it here. ";
  static const clickToContinue = "click to continue.";
  static const generateChannelQrCode = "Generate Channel QR Code Here";
  static const gender = "gender";
  static const youCanGenerate =
      "you can generate qr code for each channel you create. ";
  static const clickToGenerate = " click to generate.";
  static const youCanCreateAs =
      "you can create as many QR Code for as many channel as you like";
  ...
  static const iRememberMyUsername =
      "i remember my username and password. I will just ";
  ...
  static const ifYouKnowTheChannelName =
      "If you know the channel you want join. Simply add it in the  text field above.";
  static const ifYouKnowTheSubChannelName =
      "If you know the channel you want to create a sub-channel under. Simply add it in the  text field above.";
  ...
  static const moderatorCanInterruptMessages =
      "moderator can interrupt messages";
  ...
  static const thisIsAGuide =
      "This is a guide on how to use the 360  push to talk app. Its simple, simply push to talk or chat. ";
  static const signUpTo360 =
      "Sign up to 360  by filling all the required information.";
  static const createASupperChannel =
      "Create a super channel, that    reflect your purpose.";
  static const onBoardChannelUsers =
      "Onboard channel users from your contact. You can also create sub-channel and onboard sub-channel users from your contact. ";
  static const onBoardedChannelUsersCanAlso =
      "Onboarded channel users can also chat within the channel they belong. Likewise users who belong to the sub-channel. ";
  static const youCanBeginToPush =
      "You can begin to push to talk to members of your channel.";
